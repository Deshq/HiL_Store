...
namespace HiL_Store.Domain.Services.Authentication
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<Account> Login(string username, string password)
        {
            ...
            string hashedPassword = storedAccount.AccountHolder.PasswordHash;
            PasswordVerificationResult passwordResult = _passwordHasher.VerifyHashedPassword(hashedPassword, password);
        ...
        public async Task<RegistrationResult> Register(string email, string username, string password,
            string confirmPassword, string userRole)
        {
